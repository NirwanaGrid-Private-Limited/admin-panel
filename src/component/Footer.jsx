  ...
  return <footer className="w-full">
    ...
    /* Brand Column */
            ...
            <div className="space-y-2 flex flex-col items-center">
              <img src={imgLogo1} alt="NirwanaGrid" style={{ width: '180px', height: '120px', opacity: 1, transform: 'rotate(0deg)' }} className="object-contain" />
              <p
    ...
    /* Socials */
              ...
              <div className="flex gap-5 mt-6">
                <a href="#" className="w-8 h-8 bg-[#313131] opacity-60 rounded flex items-center justify-center text-white hover:opacity-100 transition-opacity">
                  <Facebook size={14} fill="white" className="text-transparent" />
                </a>
                <a href="#" className="w-8 h-8 bg-[#313131] opacity-60 rounded flex items-center justify-center text-white hover:opacity-100 transition-opacity">
                  <Twitter size={14} fill="white" className="text-transparent" />
                </a>
                <a href="#" className="w-8 h-8 bg-[#313131] opacity-60 rounded flex items-center justify-center text-white hover:opacity-100 transition-opacity">
                  <Instagram size={14} />
                </a>
                <a href="#" className="w-8 h-8 bg-[#313131] opacity-60 rounded flex items-center justify-center text-white hover:opacity-100 transition-opacity">
                  <Linkedin size={14} fill="white" className="text-transparent" />
                </a>
              </div>
            </div>
    ...
    /* Bottom Bar */
      ...
      <div className="bg-[#434547] py-4">
        <div className="container mx-auto px-2 md:px-4 flex flex-col lg:flex-row justify-between items-center text-[#d1d1d1]">
          <p className="text-xs font-medium font-['Inter']">©copyright 2025 Nirwana Grid. All Rights Reserved</p>
          <div className="flex flex-col md:flex-row gap-4 mt-2 lg:mt-0 text-xs font-medium font-['Inter']">
